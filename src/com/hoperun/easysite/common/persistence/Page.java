...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled\"><a href=\"javascript:\" style=\"margin-right:2px;\">下一页 &#187;</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\" style=\"margin-right:2px;\" onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\">"
					+ "下一页 &#187;</a></li>\n");
		}
		...
		sb.insert(0,"<nav aria-label=\"Page navigation\"><ul class=\"pagination\">\n").append("</ul></nav>\n");
