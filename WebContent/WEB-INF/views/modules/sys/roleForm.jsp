...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label col-sm-2">归属机构:</label>
			<div class="col-sm-2">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			 <div  class="pull-left"> 
				...
				<form:input path="enname" htmlEscape="false" maxlength="50" class="required form-control input-medium pull-left"  />
				</div>
			   <div class="help-inline">&nbsp;   <font color="red">*</font></div>
		...
		<div class="form-group">
			<label class="control-label col-sm-2">是否系统数据:</label>
			<div class="col-sm-10">
		...
		<div class="form-group">
			<label class="control-label col-sm-2">数据范围:</label>
			<div class="col-sm-10">
				...
				<span class="help-block">特殊情况下，设置为“按明细设置”，可进行跨机构授权</span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<c:if test="${(role.sysData eq fns:getDictValue('是', 'yes_no', '1') && fns:getUser().admin)||!(role.sysData eq fns:getDictValue('是', 'yes_no', '1'))}">
				<shiro:hasPermission name="sys:role:edit"><input id="btnSubmit" class="btn btn-default btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
			</c:if>
