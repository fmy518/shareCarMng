 ...
 */
package com.hoperun.easysite.modules.gen.entity;
...
public class GenTableColumn extends DataEntity<GenTableColumn> {
    ...
    public boolean equals(Object o) {
        ...
        if (getGenTable() != null ? !getGenTable().equals(that.getGenTable()) : that.getGenTable() != null)
            return false;
        if (getName() != null ? !getName().equals(that.getName()) : that.getName() != null)
            return false;
        if (getComments() != null ? !getComments().equals(that.getComments()) : that.getComments() != null)
            return false;
        if (getJdbcType() != null ? !getJdbcType().equals(that.getJdbcType()) : that.getJdbcType() != null)
            return false;
        if (getJavaType() != null ? !getJavaType().equals(that.getJavaType()) : that.getJavaType() != null)
            return false;
        if (getJavaField() != null ? !getJavaField().equals(that.getJavaField()) : that.getJavaField() != null)
            return false;
        if (getIsPk() != null ? !getIsPk().equals(that.getIsPk()) : that.getIsPk() != null)
            return false;
        if (getIsNull() != null ? !getIsNull().equals(that.getIsNull()) : that.getIsNull() != null)
            return false;
        if (getIsInsert() != null ? !getIsInsert().equals(that.getIsInsert()) : that.getIsInsert() != null)
            return false;
        if (getIsEdit() != null ? !getIsEdit().equals(that.getIsEdit()) : that.getIsEdit() != null)
            return false;
        if (getIsList() != null ? !getIsList().equals(that.getIsList()) : that.getIsList() != null)
            return false;
        if (getIsQuery() != null ? !getIsQuery().equals(that.getIsQuery()) : that.getIsQuery() != null)
            return false;
        if (getQueryType() != null ? !getQueryType().equals(that.getQueryType()) : that.getQueryType() != null)
            return false;
        if (getShowType() != null ? !getShowType().equals(that.getShowType()) : that.getShowType() != null)
            return false;
        if (getDictType() != null ? !getDictType().equals(that.getDictType()) : that.getDictType() != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = getGenTable() != null ? getGenTable().hashCode() : 0;
        result = 31 * result + (getName() != null ? getName().hashCode() : 0);
        result = 31 * result + (getComments() != null ? getComments().hashCode() : 0);
        result = 31 * result + (getJdbcType() != null ? getJdbcType().hashCode() : 0);
        result = 31 * result + (getJavaType() != null ? getJavaType().hashCode() : 0);
        result = 31 * result + (getJavaField() != null ? getJavaField().hashCode() : 0);
        result = 31 * result + (getIsPk() != null ? getIsPk().hashCode() : 0);
        result = 31 * result + (getIsNull() != null ? getIsNull().hashCode() : 0);
        result = 31 * result + (getIsInsert() != null ? getIsInsert().hashCode() : 0);
        result = 31 * result + (getIsEdit() != null ? getIsEdit().hashCode() : 0);
        result = 31 * result + (getIsList() != null ? getIsList().hashCode() : 0);
        result = 31 * result + (getIsQuery() != null ? getIsQuery().hashCode() : 0);
        result = 31 * result + (getQueryType() != null ? getQueryType().hashCode() : 0);
        result = 31 * result + (getShowType() != null ? getShowType().hashCode() : 0);
        result = 31 * result + (getDictType() != null ? getDictType().hashCode() : 0);
