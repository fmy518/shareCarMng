...
<div class="wrapper">
            ...
            <ul class="sidebar-menu">
                ...
                <c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
                    <c:if test="${menu.parent.id eq firstMenuId &&menu.isShow eq '1'}">
                        ...
                        <a href="#">
                            <i class="fa ${menu.icon} fa-lg"></i> <span>${menu.name}</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
						...
						<c:forEach var="vo" items="${fns:getMenuList()}">
							<c:if test="${vo.parent.id eq menu.id &&vo.isShow eq '1'}">
								...
								<a href="${fn:indexOf(vo.href, '://') eq -1 ? ctx : ''}${vo.href}" data-id="${vo.id}" target="mainFrame"><i
									class="fa ${vo.icon} fa-lg"></i> ${vo.name}</a>
								   </li>
								<c:if test="${firstUrl==''}">
									<c:set var="firstUrl"
    ...
    <div class="content-wrapper">
        <section class="content">
            <iframe id="mainFrame" name="mainFrame" src="${firstUrl}" style="overflow:visible;" scrolling="yes" frameborder="no" width="100%"></iframe>
        </section>
    </div>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 <a href="#">Easysite</a>.</strong> All rights
        reserved.
    </footer>
...
<script type="text/javascript">
$(function(){
	$("#mainFrame").height($(".content-wrapper").height()-5);
});
