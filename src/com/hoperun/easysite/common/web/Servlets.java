 ...
 */
package com.hoperun.easysite.common.web;
...
public class Servlets {
    ...
    public static void setFileDownloadHeader(HttpServletResponse response, String fileName) {
        // 中文文件名支持
        String encodedfileName = new String(fileName.getBytes(Charset.forName("UTF-8")), Charset.forName("UTF-8"));
    ...
    public static String encodeHttpBasic(String userName, String password) {
        ...
        return "Basic " + Encodes.encodeBase64(encode.getBytes(Charset.forName("UTF-8")));
    }
