...
<body>
	...
	<form:form id="searchForm" modelAttribute="dict" action="${ctx}/sys/dict/" method="post" class="breadcrumb form-search form-inline" role="form">
		...
		&nbsp;<input id="btnSubmit" class="btn btn-default btn-primary" type="submit" value="查询"/>
	</form:form>
